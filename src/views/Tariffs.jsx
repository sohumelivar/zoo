        ...
        <div className="row bgimg1">
          ...
          <div className="row">
            ...
            <div className="col-lg-8 col-md-8 col-sm-8 col-xs-8 opacity">
              ...
              <p className="info"> Мы разработали для вас оптимальный маршрут, который позволит не только безопасно наслаждаться прогулкой по территории зоопарка, но и увидеть всех наших обитателей.
                Мы ждем вас!
              </p>
              <p className="info"> </p>
            </div>
